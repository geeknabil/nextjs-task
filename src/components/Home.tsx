  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-8">
        ...
        {tasks.length > 0 && (<p className='text-center text-2xl'>Time Spent: {formatTime(timeSpent || 0)}</p>)}
        {tasks.length === 0 && (<p className='text-xl text-center mt-16 text-red-400'>No tasks found</p>)}
            ...
            <li key={task.id} className="bg-white p-4 rounded-md shadow-md">
              ...
              <div className="mt-4 space-x-2">
                ...
                {trackingTask?.id === task.id && (
                    ...
                    <p className="mb-2">Tracking Task: {task.title}</p>
                    <p className="mb-2">Timer: {formatTime(elapsedTime)}</p>
                    </div>
                )}
